...
# :username, :password, :password_confirmation, :name, :age, :gender, :email, :image, :description, :occupation, :sociability, :is_smoker, :pets, :roommate, :max_rent
...
u2 = User.create(:username =>'Seth123', :password => 'abc', :password_confirmation => 'abc', :name => 'Seth', :age => '30', :gender => 'Male', :email => 'seth@gmail.com', :image => 'users/seth.jpg', :description =>"Hey guys! I like turtles and barbecue sauce.", :occupation =>'Actor', :sociability =>'3', :is_smoker =>false, :pets =>'Have', :roommate => {:gender=>'Male'}, :max_rent => '1800')
