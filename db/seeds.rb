...
u1 = User.create(:password => 'abc', :password_confirmation => 'abc', :name => 'Sean', :age => '25', :gender => 'Male', :email => 'sean@gmail.com', :image => 'users/sean.jpg', :description =>"I'm a friendly, generally quiet guy who keeps weird hours.", :occupation =>'Web developer', :sociability =>2, :sleep_hours =>2, :is_smoker =>false, :pets =>'Want', :roommate => {:max_age=>'30', :min_age=>'23', :gender=>'Either', :is_smoker=>false, :employed=>true}, :max_rent => '1000')
u2 = User.create(:password => 'abc', :password_confirmation => 'abc', :name => 'Seth', :age => '30', :gender => 'Male', :email => 'seth@gmail.com', :image => 'users/seth.jpg', :description =>"Hey guys! I like turtles and barbecue sauce.", :occupation =>'Actor', :sociability =>'3',:sleep_hours =>3, :is_smoker =>false, :pets =>'Have', :roommate => {:gender=>'Male'}, :max_rent => '1800')
u3 = User.create(:password => 'abc', :password_confirmation => 'abc', :name => 'Lola', :age => '19', :gender => 'Female', :email => 'lolita@gmail.com', :image => 'users/lola.jpg', :description =>"Accepting applications for sugar daddies.", :occupation =>'Unemployed', :sociability =>3, :is_smoker =>true, :pets =>"Don't want", :roommate => {:max_age=>50, :min_age=>30, :gender=>'Male'}, :max_rent => '600')
u4 = User.create(:password => 'abc', :password_confirmation => 'abc', :name => 'Stacey', :age => '28', :gender => 'Female', :email => 'stacey@gmail.com.com', :image => 'users/stacey.jpg', :description =>"I'm a hard-working professional seeking a quiet living environment.", :occupation =>'Lawyer', :sociability =>'0', :sleep_hours=>1, :is_smoker =>false, :pets =>"Don't want", :roommate => {:max_age=>'40', :min_age=>'25', :gender=>'Female'}, :max_rent => '2200')
u5 = User.create(:password => 'abc', :password_confirmation => 'abc', :name => 'Fred', :age => '32', :gender => 'Male', :email => 'fred@gmail.com', :image => 'users/fred.jpg', :description =>"I'm your average Joe, hoping to find a good roommate and friend.", :occupation =>"Playwright", :sociability =>1, :is_smoker =>true, :sleep_hours=>3, :pets =>'Have', :roommate => {:max_age=>'40', :min_age=>'30', :gender=>'Either'}, :max_rent => '2000')
u6 = User.create(:password => 'abc', :password_confirmation => 'abc', :name => 'George', :age => '23', :gender => 'Male', :email => 'george@gmail.com', :image => 'users/george.jpg', :description =>"I'm fun-loving, active, and generally hard-of-hearing.", :occupation =>'Candy shop emplyee', :sociability =>3, :sleep_hours=>2, :is_smoker =>false, :pets =>'Want', :roommate => {:max_age=>30, :gender=>'Either'}, :max_rent => '800')
u7 = User.create(:password => 'abc', :password_confirmation => 'abc', :name => 'Brook', :age => '29', :gender => 'Female', :email => 'brook@gmail.com', :image => 'users/brook.jpg', :description =>"Hi, I'm Brook! I love to clean!", :occupation =>'Dog groomer', :sociability =>2, :sleep_hours=>2, :is_smoker =>false, :pets =>'Have', :roommate => {:gender=>'Either'}, :max_rent => '2000')
u8 = User.create(:password => 'abc', :password_confirmation => 'abc', :name => 'Gabrielle', :age => '26', :gender => 'Female', :email => 'gabrielle@gmail.com', :image => 'users/gabrielle.jpg', :description =>"Hey, Gabrielle here. I grow my own vegetables and my dress is made out of wheat.", :occupation =>'Organic argiculturalist', :sociability =>3, :sleep_hours=>3, :is_smoker =>false, :pets =>'Have', :roommate => {:gender=>'Either'}, :max_rent => '900')
u9 = User.create(:password => 'abc', :password_confirmation => 'abc', :name => 'Aaron', :age => '29', :gender => 'Male', :email => 'aaron@gmail.com', :image => 'users/aaron.jpg', :description =>"Super easy-going guy searchin' for a great roomie.", :occupation =>'Hammock tester', :sociability =>2, :sleep_hours=>2, :is_smoker =>false, :pets =>'Want', :roommate => {:gender=>'Either'}, :max_rent => '2000')
